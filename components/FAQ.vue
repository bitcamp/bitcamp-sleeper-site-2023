    ...
    <div class="FAQ_Section">
        ...
        <div class="Question_Wrapper">
            <div class="Question_Column">
                <div class="Question" v-for="(faq, i) in questions_left" :faq="faq" :key="i">
                    <button @click="toggleButton(faq.question)" class="Question_Button"
            ...
            <div class="Question_Column">
                <div class="Question" v-for="(faq, i) in questions_right" :faq="faq" :key="i">
                    <button @click="toggleButton(faq.question)" class="Question_Button"
                        :class="{ opened: faq.question === currentOpenedQuestion }">
                        {{ faq.question }}
                    </button>
